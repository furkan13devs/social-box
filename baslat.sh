...
echo ""
echo -e "		$Cyan 1 : FACE BOOK BRUTE FORCE İCİN$nc"
echo -e "		$Cyan 2 : GMAİL BRUTE FORCE İÇİN$nc"
echo -e "		$Cyan 3 : İNSTAGRAM BRUTE FORCE İÇİN$nc"
echo -e "		$Cyan 4 : TWİTTER BRUTE FORCE İÇİN$nc"
echo -e "		$Cyan 5 : İNSTA BRUTE FORCE 2İÇİN $nc"
echo -e "		$Cyan 99: ÇIKIŞ$nc"
read -p "Choice >  " ch
if [ $ch = 1 ]; then
